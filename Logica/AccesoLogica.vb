...
#Region "TY005 PRODUCTOS"
    ...
    Public Shared Function L_fnGrabarProducto(ByRef _yfnumi As String, _yfcprod As String,
                                              ...
                                              _yfgr3 As Integer, _yfgr4 As Integer, _yfMed As Integer, _yfumin As Integer, _yfusup As Integer, _yfvsup As Double, _yfsmin As Integer, _yfap As Integer, _yfimg As String, _dtimg As DataTable) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@yfuact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@TY0052", "", _dtimg))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TY005", _listParam)
    ...
    Public Shared Function L_fnModificarProducto(ByRef _yfnumi As String, _yfcprod As String,
                                              _yfcbarra As String, _yfcdprod1 As String,
                                              _yfcdprod2 As String, _yfgr1 As Integer, _yfgr2 As Integer,
                                              _yfgr3 As Integer, _yfgr4 As Integer, _yfMed As Integer, _yfumin As Integer, _yfusup As Integer, _yfvsup As Double, _yfsmin As Integer, _yfap As Integer, _yfimg As String, _dtimg As DataTable
                                              ) As Boolean
        Dim _resultado As Boolean
...
#Region "TV001 Ventas"
    ...
    Public Shared Function L_fnListarTipoVenta() As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnGrabarVenta(ByRef _tanumi As String, _taidCorelativo As String, _tafdoc As String, _taven As Integer, _tatven As Integer, _tafvcr As String, _taclpr As Integer,
                                           ...
                                           _tatotal As Double, detalle As DataTable, _almacen As Integer, _taprforma As Integer, _tabanco As Integer, _tanrocheque As String, _taanticipo As Integer, _tamontoanticipo As Double) As Boolean
        Dim _Tabla As DataTable
        Dim _resultado As Boolean
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        _listParam.Add(New Datos.DParametro("@tauact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@tabanco", _tabanco))
        _listParam.Add(New Datos.DParametro("@taanticipo", _taanticipo))
        _listParam.Add(New Datos.DParametro("@tamontoanticipo", _tamontoanticipo))
        _listParam.Add(New Datos.DParametro("@tanrocheque", _tanrocheque))
    ...
    Public Shared Function L_fnModificarVenta(_tanumi As String, _tafdoc As String, _taven As Integer, _tatven As Integer, _tafvcr As String, _taclpr As Integer,
                                           _tamon As Integer, _taobs As String,
                                           _tadesc As Double, _taice As Double, _tatotal As Double, detalle As DataTable, _almacen As Integer, _taprforma As Integer, _tabanco As Integer, _tanrocheque As String, _taanticipo As Integer, _tamontoanticipo As Double) As Boolean
        Dim _Tabla As DataTable
        Dim _resultado As Boolean
        Dim _listParam As New List(Of Datos.DParametro)
...
#Region "TY0051 Categoria Producto"
    ...
    Public Shared Function L_fnModificarCategoria(ByRef _ygnumi As String, _ygnombre As String, _ygcodigo As String,
                                               _ygcategoria As Integer, _ygimg As String, _ygestado As Integer) As Boolean
        Dim _resultado As Boolean
        ...
        Return _resultado
    End Function
    Public Shared Function L_fnGeneralCategoria() As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnEliminarCategoriaProducto(numi As String, ByRef mensaje As String) As Boolean
        Dim _resultado As Boolean
        If L_fnbValidarEliminacion(numi, "TY0051", "ygnumi", mensaje) = True Then
            Dim _Tabla As DataTable
            Dim _listParam As New List(Of Datos.DParametro)
...
#Region "TA001 Almacen"
    ...
    Public Shared Function L_fnListarCategoria() As DataTable
        Dim _Tabla As DataTable
...
#Region "REPORTES VS VENTAS"
    ...
    Public Shared Function L_prVentasCajaDetalladaUnaSucursal(fechaI As String, fechaF As String, _sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prVentasCajaTipoVentaUnaSucursal(fechaI As String, fechaF As String, _sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
