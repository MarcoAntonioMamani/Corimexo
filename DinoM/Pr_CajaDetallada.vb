...
Public Class Pr_CajaDetallada
    ...
    Public Sub _prInterpretarDatos(ByRef _dt As DataTable, ByRef _dt1 As DataTable)
        ...
        Else
            If (CheckUnaALmacen.Checked And tbAlmacen.SelectedIndex >= 0) Then
                _dt = L_prVentasCajaDetalladaUnaSucursal(tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"), tbAlmacen.Value)
                _dt1 = L_prVentasCajaTipoVentaUnaSucursal(tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"), tbAlmacen.Value)
            End If
    ...
    Private Sub Pr_CajaDetallada_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        _prIniciarTodo()
