...
Public Class Efecto
    ...
    Private Sub Efecto_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Select Case tipo
            ...
            Case 4
                _prLogin()
            Case 5
                _prMostrarFormAyudaImagenes()
        End Select
    End Sub
    Public Sub _prLogin()
        Dim blah As New Bitmap(New Bitmap(My.Resources.man_28), 20, 20)
    ...
    Sub _prMostrarFormAyudaImagenes()

        Dim frmAyuda As F0_ModeloAyudaImagenes
        frmAyuda = New F0_ModeloAyudaImagenes(alto, ancho, dt, Context.ToUpper, listEstCeldas)
        If (SeleclCol >= 0) Then
            frmAyuda.Columna = SeleclCol
            frmAyuda._prSeleccionar()
