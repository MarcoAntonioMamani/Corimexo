...
#Region "METODOS SOBRECARGADOS"
    ...
    Public Overrides Function _PMOGrabarRegistro() As Boolean
        ...
        Dim res As Boolean = L_fnGrabarClase(tbCodigoOriginal.Text, tbNombre.Text, tbdesccorta.Text, CodigoCategoria, CodigoGrupo, nameImg, IIf(swEstado.Value = True, 1, 0))
    ...
    Public Overrides Function _PMOModificarRegistro() As Boolean
        ...
        If (Modificado = False And nameImage <> "") Then
            ...
            res = L_fnModificarClase(tbCodigoOriginal.Text, tbNombre.Text, tbdesccorta.Text, CodigoCategoria, CodigoGrupo, nameImage, IIf(swEstado.Value = True, 1, 0))

        Else

            res = L_fnModificarClase(tbCodigoOriginal.Text, tbNombre.Text, tbdesccorta.Text, CodigoCategoria, CodigoGrupo, nameImg, IIf(swEstado.Value = True, 1, 0))
    ...
    Public Overrides Sub _PMOEliminarRegistro()
        ...
        If (bandera = True) Then
            ...
            Dim res As Boolean = L_fnEliminarClaseProducto(tbCodigoOriginal.Text, mensajeError)
            If res Then
    ...
    Public Overrides Function _PMOGetTablaBuscador() As DataTable
        Dim dtBuscador As DataTable = L_fnGeneralClase()
        Return dtBuscador
    End Function
    ...
    Public Overrides Function _PMOGetListEstructuraBuscador() As List(Of Modelo.Celda)
        ...
        listEstCeldas.Add(New Modelo.Celda("ygnombre", True, "nombre Clase".ToUpper, 300))
...
#End Region
    Private Sub F1_Clase_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        _prIniciarTodo()
    End Sub
End Class